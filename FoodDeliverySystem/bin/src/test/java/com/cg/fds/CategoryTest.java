...
class CategoryTest {
	...
	{ 
		...
		Category actCategory = iCategoryService.updateCategory(expCategory.getCatId(),expCategory);
...
//	}
	...
	public void viewCategoryTest() throws Exception
	{
		...
		Category actCategory = iCategoryService.viewCategory(expCategory.getCatId());
		assertEquals(actCategory.getCategoryName(), expCategory.getCategoryName());
