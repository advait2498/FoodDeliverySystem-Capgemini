...
IRestaurantRepository restaurantRepository;
	...
	public void updateRestaurant() {
		 ...
		 Restaurant actual=restaurantServiceImpl.updateRestaurant(expected);
		 assertEquals(expected.getRestaurantId(),actual.getRestaurantId());
	 }
	...
	@Test
	 public void removeRestaurant() {
		 ...
		 Restaurant actual = restaurantServiceImpl.removeRestaurant(expected);
		 assertEquals(expected.getRestaurantId(),actual.getRestaurantId());
	 }
	...
	public void viewRestaurant() {
		...
		Restaurant actual = restaurantServiceImpl.viewRestaurant("Pariwaar");
    ...
    public void findByRestaurantName() {
        ...
        List<Item> list = restaurantServiceImpl.viewAllItemsByRestaurant(restaurant3.getRestaurantName());
